...
<project_description>
# Aplikacja - funnyMMS (MVP)

### Główny problem
Wymyślanie śmiesznych mms jest trudne. Dzięki funnyMMS będziesz mógł wygenerować śmieszną grafikę na podstawie kilku zdań w języku polskim i wysłać mms na własny telefon

### Najmniejszy zestaw funkcjonalności
- Generowanie i wysyłanie mms na numer zalogowanego użytkownika po wcześniejszym zweryfikowaniu numeru telefonu i użytkownikiem, który go wskazał
- Prosty system kont użytkowników do powiązania użytkownika z historią wysłanych mms z limitem dziennym 5 mms dla każdego użytkownika
- Strona profilu użytkownika służąca do przeglądania historii wysłanych mms z podglądem wiadomości graficznej
- Integracja z AI umożliwiająca generowanie grafik, które będą wysłane w mms

### Co NIE wchodzi w zakres MVP
- Współdzielenie historii mms między kontami
- możliwość zostawienia mms w wersji roboczej
- Zaawansowane statystyki 
### Kryteria sukcesu
- 90% użytkowników może wysłać 5 mms dziennie
- 75% użytkowników 2 lub więcej mms dziennie
</project_description>
